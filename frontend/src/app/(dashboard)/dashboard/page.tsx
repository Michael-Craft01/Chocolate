    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-white/5 pb-8">
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-primary text-sm font-semibold  tracking-normal">
            <Sparkles className="h-4 w-4 glow-primary" /> System: Synchronized
          </div>
          <h1 className="text-4xl font-semibold tracking-tight gradient-text">Command Center</h1>
          <p className="text-sm text-zinc-500 font-bold  tracking-[0.1em]">Autonomous Lead Extraction & Intelligence Monitoring.</p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="glass-card px-5 py-2.5 rounded-sm flex items-center gap-3">
            ...
            <span className="text-sm font-semibold  tracking-normal text-zinc-400">Node: Active</span>
          </div>
          <div className="glass-card px-5 py-2.5 rounded-sm bg-primary/10 border-primary/20 flex items-center gap-2">
            <Zap className="h-4 w-4 text-primary fill-primary" />
            <span className="text-sm font-semibold  tracking-normal text-primary">{stats?.tier || 'FREE'} ENGINE</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-8 glass-card rounded-sm overflow-hidden relative min-h-[400px] group">
          <div className="absolute top-0 left-0 p-10 z-20 pointer-events-none">
            <h2 className="text-lg font-semibold  tracking-normal mb-2 flex items-center gap-2">
              Neural Network <div className="h-1.5 w-1.5 rounded-sm bg-primary animate-ping" />
            </h2>
            <p className="text-sm text-zinc-500 font-bold  tracking-normal">Real-time Global Sync</p>
          </div>
          <NeuralPulse />
          <div className="absolute bottom-0 right-0 p-10 z-20 pointer-events-none text-right">
            <p className="text-4xl font-semibold tracking-tight text-white glow-text">84.2%</p>
            <p className="text-sm text-zinc-500 font-bold  tracking-normal mt-1">Extraction Yield</p>
          </div>
        </div>
        ...
        <div className="md:col-span-4 flex flex-col gap-6">
          <div className="flex-1 glass-card rounded-sm p-8 flex flex-col justify-between group">
            <div className="flex justify-between items-start">
              <div className="space-y-2">
                <p className="text-sm font-semibold text-zinc-500  tracking-normal">Total Captures</p>
                <p className="text-4xl font-semibold tracking-tight text-white">{stats?.totalLeads || 0}</p>
              </div>
            ...
            <div className="flex items-end justify-between mt-8">
              <div className="text-sm text-emerald-400 font-semibold flex items-center gap-1.5  tracking-normal">
          ...
          <div className="flex-1 glass-card rounded-sm p-8 flex flex-col justify-between group">
            <div className="flex justify-between items-start">
              <div className="space-y-2">
                <p className="text-sm font-semibold text-zinc-500  tracking-normal">Active Businesses</p>
                <p className="text-4xl font-semibold tracking-tight text-white">{stats?.totalBusinesses || 0}</p>
              </div>
            ...
            <div className="flex items-end justify-between mt-8">
              <div className="text-sm text-zinc-500 font-semibold flex items-center gap-1.5  tracking-normal">
        ...
        <div className="md:col-span-7 glass-card rounded-sm p-10 space-y-8 group">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-sm font-semibold  tracking-normal">Intelligence Feed</h2>
                <p className="text-sm text-zinc-500 font-bold  tracking-normal mt-1">Live Extraction Telemetry</p>
              </div>
            </div>
            <button className="text-sm font-semibold text-zinc-500 hover:text-white transition-all  tracking-normal flex items-center gap-2 group/btn">
            ...
            {(recentLeads?.length || 0) > 0 ? recentLeads.map((lead, i) => (
              ...
              >
                <div className="flex items-center gap-5">
                  <div className="h-12 w-12 rounded-sm bg-white/5 border border-white/5 flex items-center justify-center font-semibold text-zinc-400 text-sm group-hover/item:border-primary/30 transition-colors">
                    {lead.business.name.charAt(0)}
                  </div>
                  <div>
                    <p className="text-sm font-semibold tracking-tight text-white">{lead.business.name}</p>
                    <p className="text-sm text-zinc-500 font-semibold  tracking-[0.1em] mt-0.5">{lead.industry}</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-sm font-semibold text-primary  tracking-normal glow-text">Qualified</p>
                  <p className="text-xs text-zinc-700 font-bold  tracking-normal mt-1">
                    {new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                  </p>
                </div>
              </motion.div>
            )) : (
              <div className="py-20 text-center text-zinc-600 font-bold  tracking-normal text-sm">
        ...
        <div className="md:col-span-5 flex flex-col gap-6">
          <div className="glass-card rounded-sm p-10    relative overflow-hidden group flex-1">
             <div className="relative z-10 space-y-6">
                <div className="flex items-center gap-3 text-primary">
                  ...
                  <span className="text-sm font-semibold  tracking-normal">Neural Insight</span>
                </div>
                ...
                <p className="text-sm text-zinc-500 leading-relaxed font-semibold  tracking-normal">OPTIMIZE EXTRACTION NODES FOR MAXIMUM CAPTURE.</p>
             </div>
          ...
          <div className="glass-card rounded-sm p-8 flex items-center justify-between group border border-white/5">
            <div className="space-y-2">
              <p className="text-sm font-semibold text-zinc-500  tracking-normal">Engine Quota</p>
              <p className="text-2xl font-semibold tracking-tight text-white">{stats?.quota?.used || 0} / {stats?.quota?.limit || 10}</p>
            </div>
