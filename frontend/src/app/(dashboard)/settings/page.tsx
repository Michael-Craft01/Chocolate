...
export default function SettingsPage() {
  ...
  const inputClass = "w-full bg-white/[0.02] border border-white/5 rounded-xl px-4 py-2.5 transition-all focus:outline-none focus:border-primary/50 text-xs font-bold";
    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pt-10">
        ...
        <button 
          onClick={handleSave}
          disabled={saving}
          className="flex items-center justify-center gap-2 px-6 py-2.5 bg-primary text-white rounded-full text-[10px] font-black uppercase tracking-widest hover:brightness-110 transition-all shadow-xl shadow-primary/10 disabled:opacity-50 min-w-[140px]"
        >
      ...
      <form onSubmit={handleSave} className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="glass p-6 rounded-2xl border border-white/5 space-y-4">
            ...
            <div className="p-3 rounded-xl bg-primary/5 border border-primary/10 flex gap-2 items-start">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2 mb-2">
            <div className="w-8 h-8 rounded-lg bg-emerald-500/10 flex items-center justify-center text-emerald-500/70">
              <Globe size={16} />
            </div>
      ...
      {/* Calibration Card */}
      <div className="glass rounded-3xl p-8 border border-white/5 relative overflow-hidden group interactive-card">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
          ...
          <button 
            onClick={handleSave}
            className="px-8 py-3 bg-white text-black text-[10px] font-black uppercase tracking-widest rounded-full hover:brightness-90 transition-all shadow-xl flex items-center gap-2"
          >
