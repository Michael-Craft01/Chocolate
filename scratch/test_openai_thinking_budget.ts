  ...
  try {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are a professional B2B assistant. Your job is to refine user inputs into professional descriptions. Return ONLY a valid JSON object with the key 'refined'. Do NOT output any thinking, drafts, or markdown. IMPORTANT: Do not use <thought> tags or include your reasoning in the output."
        },
        {
          role: "user",
