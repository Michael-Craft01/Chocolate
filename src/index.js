...
async function processLeadsForQuery(queryData, targetCount) {
    let leadsFound = 0;
    try {
        ...
        for (const business of businesses) {
            ...
            // Generate Message
            const message = messageGenerator.generate(business.name, enrichment.industry, enrichment.painPoint, enrichment.recommendedSolution);
            // Save Lead
